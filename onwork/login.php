...
<body class="login-body">
    <div class="login-container">
        ...
        <div class="login-card">
            ...
            <form class="login-form" id="loginForm" method="POST" action="login-handler.php" onsubmit="return validateLoginForm()">
                ...
                <div class="login-options">
                    ...
                    <!-- <a href="forgetpass.php" class="login-forgot">Forgot Password?</a> -->
                </div>
